   ...
   <body>
      ...
      <form action="<%=request.getContextPath()%>/"method="post">
         ...
         <table align="center"border="1"width="70%">
            ...
            <% //if(!"add".equals(request.getParameter("current_action"))) 
            ...
            <tr>
               ...
               <td>
                  <%
                     ...
                     for(HashMap.Entry<String, String> pair:person.getPhones().entrySet())                     
                     {
                     ...
                     %>
                  &nbsp;
                  <a href="<%=request.getContextPath()%>/?action=editPhone&id=<%=person.getId()+"tel"+pair.getKey() %>">Редактировать</a>
                  &nbsp;
                  <a href="<%=request.getContextPath()%>/?action=delete_phone&id=<%=person.getId()+"tel"+pair.getKey() %>">Удалить</a>
                  <br />
                  <%
                     }
                     %>
